...
import { ExcessLabel } from "../../components/ui/media-and-icons/ExcessLabel";
...
export const WithCustomIcon = () => (
  <AvatarGroup>
    <Avatar w="40px" h="40px" icon={<GenericAvatar />} />
  ...
  <Stack direction="row" spacing="24px">
    {["xs", "sm", "md", "lg", "xl", "2xl"].map((size) => (
      <Avatar
        ...
        size={size}
        name="Uchiha Itachi"
        src="https://uinames.com/api/photddos/female/18.jpg"
      >
...
export const WithAvatarGroup = () => (
  <Stack direction="row" gap="0">
    <AvatarGroup size="sm">
      <Avatar name="Ryan Florence" src="https://bit.ly/sage-adebayo" />
      <Avatar name="Kent Dodds" src="https://bit.ly/sage-adebayo" />
      <Avatar name="Prosper Otemuyiwa" src="https://bit.ly/sage-adebayo" />
      <Avatar
        name="Christian Nwamba"
